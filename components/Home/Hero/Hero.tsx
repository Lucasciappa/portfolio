		...
		<div className="space-y-6 py-6">
			<div className="flex flex-col-reverse gap-8 md:flex-row md:justify-between">
				<div className="space-y-4 max-w-full">
					<div className=" ring-[5px] ring-purple-500/10 border border-gray-800 rounded-full h-36 w-36 bg-gradient-to-r from-[#071127] to-[#1c0942] relative mx-auto md:mx-0 ">
						<Image
							src="/me.jpg"
							fill
							alt="profile-picture"
					...
					<h1 className="mb-1 text-3xl font-bold tracking-tight text-zinc-800 md:text-4xl bg-clip-text dark:text-transparent bg-gradient-to-r from-pink-500 via-primary-coral to-yellow-500">
						Hola, soy Lucas {" "} <br className="md:hidden"/><span className="text-[22px] font-light text-primary-black dark:text-gray-300 dark:text-opacity-20">Full-Stack Developer
						</span>
					</h1>
