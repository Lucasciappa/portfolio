...
const Angular = ({ width, height }: AngularProps) => {
    return (
<svg className="icon icon-tabler icon-tabler-brand-github" width={width} height={height} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
