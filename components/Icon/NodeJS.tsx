...
const NodeJS = ({ width, height }: NodeJSProps) => {
    return (
        <svg className="icon icon-tabler icon-tabler-brand-github bg-white rounded-full p-1" width={width} height={height} viewBox="0 -99 512 512" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
